...
export default function SignupPage() {
  ...
  // Fluxo Único: Cadastro clássico com Email e Senha
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-[440px]">
          ...
          <div className="glass p-8 rounded-[2rem] shadow-elegant">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <button type="submit" disabled={isLoading} className="w-full bg-foreground text-background font-medium text-sm rounded-full py-3.5 mt-2 transition-all flex items-center justify-center gap-2 focus-ring disabled:opacity-50 hover:scale-[1.02] active:scale-[0.98]">
